...
if ($diaDaSemana >= 6) { // Se for sábado (6) ou domingo (7)
    ...
    if (($data_start_conv > date('Y-m-d')) ||
        ...
        if (mysqli_stmt_num_rows($checkStmt) > 0) {
            ...
            $query = "INSERT INTO events (title, color, start, end, responsible, status, ordinance, term, phone, email, dataCadastro) VALUES ('teste', 'red', now(), now(), 'ronie', '2', 'texto-ord', now(), '5521965973203', 'peter@peter.com', now())";
