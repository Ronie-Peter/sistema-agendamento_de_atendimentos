<?php
    ...
    //var_dump($horarioAgendamento > date('H:i')); die;
    if ($data_start_conv > date('Y-m-d')) {
        ...
        $retorna = ['sit' => false, 'msg' => '<div class="alert alert-danger" role="alert">Ocorreu um erro no agendamento! Não é possível realizar agendamentos em datas e/ou horários passados.<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>'];
    }
