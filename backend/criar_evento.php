...
if ($diaDaSemana >= 6) { // Se for sábado (6) ou domingo (7)
    ...
    // Impede agendamento para um prazo inferior a 48 horas
    $retorna = [
        'sit' => false,
        'msg' => '<div class="alert alert-danger" role="alert">O agendamento deve ser feito com pelo menos 48 horas de antecedência.</div>'
    ];
} else {
